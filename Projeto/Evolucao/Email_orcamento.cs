...
namespace Evolucao
{
    public class Email_orcamento
    {
        ...
        public void EnviarEmail(string emailDestinatario, string assunto, string corpo, string caminho_arquivo1, string caminho_arquivo2, string email_remetente, string senha_email_remetente, string smtp_email_remetente, out bool erro)
        {
...
out serie_empresa, out boleto_pedido_empresa, out saida_estoque_pedido_empresa, out cod_forn_empresa);
            ...
            //mensagem.CC.Add("contato@baldi.ind.br");
            //Assunto do email 
            ...
            try
            {
                System.Net.Mail.Attachment inline = new System.Net.Mail.Attachment(@caminho_arquivo1);
            ...
            try
            {
                System.Net.Mail.Attachment inline = new System.Net.Mail.Attachment(@caminho_arquivo2);
                inline.ContentDisposition.Inline = true;
                mensagem.Attachments.Add(inline);
            }
            catch { }
